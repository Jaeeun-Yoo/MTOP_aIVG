...
epsimin = 10^(-7); % '19.04.01
% epsimin = 10^(-9); % '19.02.19
raa0 = 0.00001;
move = 0.1; % '19.02.17 : 1.0 -> 0.5 , modified by Jaeeun, ref: MMA and GCMMA - two methods for nonlinear optimization
% move = 0.5; % '19.03.13 : 0.2 -> 0.5 , modified by Jaeeun, ref: MMA and GCMMA - two methods for nonlinear optimization
albefa = 0.1;
asyinit = 0.5;
asyincr = 1.2;
asydecr = 0.7;
